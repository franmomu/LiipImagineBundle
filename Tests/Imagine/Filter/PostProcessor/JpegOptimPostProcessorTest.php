...
class JpegOptimPostProcessorTest extends AbstractPostProcessorTestCase
{
   /**
    ...
    {
        $this->getProcessArguments(array('quality' => 1000));
    }
    ...
    {
        $this->getProcessArguments(array('max' => 50, 'quality' => 50));
    }
    ...
    {
        $this->assertContains('--max=50', $this->getProcessArguments(array('max' => 50)));
    }
